...
export class Init1767267828918 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "channels" ("channelId" text NOT NULL, "type" character varying(20) NOT NULL, "name" character varying(100), "teamId" text, "lastMessageAt" TIMESTAMP WITH TIME ZONE, "createdAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), CONSTRAINT "PK_f41d20ad5f355605bde63265d66" PRIMARY KEY ("channelId"))`);
        await queryRunner.query(`CREATE TABLE "messages" ("messageId" text NOT NULL, "channelId" text NOT NULL, "senderId" text NOT NULL, "seq" bigint NOT NULL, "content" text NOT NULL, "createdAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), CONSTRAINT "PK_9743b3cec687ac55895f0d79ae0" PRIMARY KEY ("messageId"))`);
        await queryRunner.query(`CREATE INDEX "idx_messages_channel_seq" ON "messages" ("channelId", "seq") `);
        await queryRunner.query(`CREATE TABLE "participants" ("channelId" text NOT NULL, "userId" text NOT NULL, "lastReadAt" TIMESTAMP WITH TIME ZONE, "joinedAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), CONSTRAINT "PK_0e40d3c7ca626caecea86c355fa" PRIMARY KEY ("channelId", "userId"))`);
        ...
        await queryRunner.query(`CREATE TABLE "contacts" ("ownerId" text NOT NULL, "userId" text NOT NULL, "createdAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), CONSTRAINT "PK_84b6140da23785badd9cbbf9e81" PRIMARY KEY ("ownerId", "userId"))`);
